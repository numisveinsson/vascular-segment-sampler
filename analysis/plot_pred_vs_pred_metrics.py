...
Usage:
	python analysis/plot_pred_vs_pred_metrics.py /path/to/output_dir
	python -m analysis.plot_pred_vs_pred_metrics /path/to/output_dir  # if installed as package
	python analysis/plot_pred_vs_pred_metrics.py /path/to/output_dir --out-dir /path/to/figures
	python analysis/plot_pred_vs_pred_metrics.py /path/to/output_dir --metrics dice,hausdorff_sym,volume_error_rel
"""
...
from analysis.plotting.latex_table import (
	...
	write_pred_vs_pred_pairwise_wilcoxon_bonferroni_latex_table,
)
...
METRIC_ABBREVIATIONS = {
	...
	'mean_curvature_rms': 'CurvRMS',
	'dihedral_angle_p95_deg': 'Dih95',
}
...
def main(argv: list[str] | None = None) -> int:
	...
	if write_pred_vs_pred_pairwise_wilcoxon_bonferroni_latex_table is not None:
		pairwise_path = os.path.join(out_dir, 'latex_table_pairwise_wilcoxon_bonferroni.txt')
		write_pred_vs_pred_pairwise_wilcoxon_bonferroni_latex_table(
			df, metric_cols, pairwise_path,
			metric_display_names=METRIC_DISPLAY_NAMES,
			metric_abbreviations=METRIC_ABBREVIATIONS,
		)
