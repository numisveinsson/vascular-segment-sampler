...
Usage:
	python -m analysis.analyze_by_names /path/to/csv_folder /path/to/categories.json [--out-dir output_dir]
	python -m analysis.analyze_by_names /path/to/csv_folder /path/to/categories.json --metrics hd95_gt_to_pred,assd,dice
	python -m analysis.analyze_by_names /path/to/csv_folder /path/to/categories.json --predictions-names predictions_names.json
"""
