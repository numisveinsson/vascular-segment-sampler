...
try:
	...
	try:
		...
		# Keep Dice-per-radii usable even when volume_per_radii dependencies
		# (e.g., scipy) are unavailable.
		print("ImportError: Failed to import analysis.volume_per_radii")
		print("Using default radius buckets")
...
def dice_per_radii(
	...
	min_seg : int
		Minimum number of segments to target during subsampling. If total segments are below
		this value, all segments are used. Must be >= 1.
	radius_scale : float
