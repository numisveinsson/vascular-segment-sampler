...
Usage:
	python -m analysis.compute_metrics_meshes_pred_vs_pred /path/to/predictions_root

Example:
	# basic run: compare all pairs of subfolders under predictions_root
	python -m analysis.compute_metrics_meshes_pred_vs_pred /data/predictions_root
...
# Support both module run and direct run.
if __package__:
