...
Usage:
	python -m analysis.compute_metrics_meshes /path/to/meshes_dir --out-csv results.csv

Example:
	python -m analysis.compute_metrics_meshes /data/pred_vtps --out-csv mesh_quality.csv
