...
import random
import hashlib
from vascular_segment_sampler.vtk_functions import (
...
from vascular_segment_sampler.sitk_functions import (
...
def interpolate(locs, number_points):
    ...
    try:
        ...
        raise ImportError(
            "WRITE_TRAJECTORIES requires scipy. "
            "Install with: pip install 'vascular-segment-sampler[traj]' "
